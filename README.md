# Lintvedt2026JRSPaperRepo

This code base contains Matlab functions and scripts that are the basis for the published article “Tackling in-line spectral intensity variations with non-contact Raman probes : A strategy exploration” by Lintvedt et.al, 2026. The purpose of the code base is to provide openness around the data analysis and facilitate reproducibility of results, as well as share data associated with the paper. The code consists of one main script, handling the pipeline of the analyses. The script is dependent on four other openly available Matlab packages/toolboxes, which are redistributed as a part of this code base to allow the data analysis to be run directly after download. This includes:

C.B.Y. Cordella, D. Bertrand, SAISIR: A new general chemometric toolbox, Trends in Analytical Chemistry 54 (2014) 75–82. http://dx.doi.org/10.1016/j.trac.2013.10.009. Available on request at http://www.chimiometrie.fr/saisir\_webpage.html
...
A. Kohler, The Open EMSC toolbox, available at https://nofimadatamodeling.wordpress.com/software-downloads-list/.



Some of the functions in the author’s own code collection My\_toolbox are also relying on the Matlab Statistics and Machine Learning Toolbox, although none of the scripts associated with this paper is based on that dependency. Other resources, referenced in the author’s own code base, includes:

Bjork and Indahl, 2017, “Fast and stable partial least squares modelling: A benchmark study with theoretical comments” https://analyticalsciencejournals.onlinelibrary.wiley.com/doi/10.1002/cem.2898
